    ...
    <div className="app">
      <div className="header">
        <div className="header-left">
          ...
          <p>Analyse de conflits réglementaires · Éclairage Luxembourg</p>
        </div>
        ...
        <div className="doc-sidebar">
          ...
          {Object.values(docs).map(doc => (
            <div key={doc.id} className="doc-card">
              ...
              <div className="doc-card-meta">{doc.authority} · {doc.date}</div>
              <div className="doc-card-meta" style={{ marginTop: 4 }}>{doc.scope}</div>
              <a href={doc.url} target="_blank" rel="noopener noreferrer">↗ Source officielle</a>
            </div>
          ))}
        </div>
